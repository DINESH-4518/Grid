...
class DQN:
    def __init__(self, state_size, action_size, lr=0.01, gamma=0.99, epsilon=1.0, epsilon_decay=0.999, epsilon_min=0.1, target_update_freq = 10,  buffer_size=10000, batch_size=64):
...
class GridWorld:                               # creating grid environment
    def __init__(self, grid_size=(5, 5)):
        ...
        self.grid[0, 1] = -1  # Blocking right move from start
        self.grid[1, 1] = -1
        self.grid[1, 2] = -1
        self.grid[1, 3] = -1
        self.grid[1, 4] = -1  # Blocking the entire row except the correct path
        self.grid[2, 4] = -1
        self.grid[3, 0] = -1  # Blocking left bottom corner to create dead end
        self.grid[3, 2] = -1
        self.grid[2, 0] = -1
        self.grid[3, 4] = -1  # Blocking entire bottom row except the correct path
        self.grid[4, 2] = -1
    ...
    def step(self, action):
        ...
        # Check if the agent reached the goal or hit an obstacle
    ...
    def render(self):
        # Render the current grid with the agent's position and goal
